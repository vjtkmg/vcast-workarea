 ...
 *   mcdc bit array 1:....................size (bits): 4   count: 3      bytes:  3
 *   mcdc bit array 2:....................size (bits): 12  count: 1      bytes:  3
 *   mcdc bit array 3:....................size (bits): 32  count: 2      bytes:  9
 *   mcdc bit array 4:....................size (bits): 80  bytes:  2 *
 *   mcdc bit array 5:....................size (bits): 192 bytes:  2 *
 *   mcdc bit array 6:....................size (bits): 448 bytes:  2 *
 *   mcdc bit array 7:....................size (bits): 1024 bytes:  2 *
 *   mcdc bit array 8:....................size (bits): 2304 bytes:  2 *
 *   Total (no MC/DC pool storage):......................................bytes:  35 *
 *   
 *   mcdc_statement_pool:.................size: 8          count: 1000   bytes:  8000
 *   avlnode_pool:........................size: 8          count: 1000   bytes:  8000
 *   Total (with user configurable MC/DC pool storage):..................bytes:  16035 *
 * 
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  32035 *
 * 
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  44035 *
 */
...
char vcast_unit_stmt_bytes_11[5] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_stmt_bytes_11[5];
#else
char vcast_unit_stmt_bytes_11[5] = 
  {0,0,0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_11_0[3] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_11_0[3];
#else
char vcast_unit_optimized_mcdc_bytes_11_0[3] = 
  {0,0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_11_1[2] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_11_1[2];
#else
char vcast_unit_optimized_mcdc_bytes_11_1[2] = 
  {0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_11_2[2] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_11_2[2];
#else
char vcast_unit_optimized_mcdc_bytes_11_2[2] = 
  {0,0};
#endif
#ifdef VCAST_COVER_SHORT_ARRAY_INIT
char vcast_unit_optimized_mcdc_bytes_11_3[8] = { 0 };
#elif defined(VCAST_COVER_NO_INIT)
char vcast_unit_optimized_mcdc_bytes_11_3[8];
#else
char vcast_unit_optimized_mcdc_bytes_11_3[8] = 
  {0,0,0,0,0,0,0,0};
#endif
char vcast_unit_optimized_mcdc_bytes_11_4[1] = { 0 };
char vcast_unit_optimized_mcdc_bytes_11_5[1] = { 0 };
char vcast_unit_optimized_mcdc_bytes_11_6[1] = { 0 };
char vcast_unit_optimized_mcdc_bytes_11_7[1] = { 0 };
char vcast_unit_optimized_mcdc_bytes_11_8[1] = { 0 };
...
static const struct vcast_unit_list vcast_unit_list_values[] = {
  {9, (char *)vcast_unit_stmt_bytes_9, sizeof(vcast_unit_stmt_bytes_9), (char *)vcast_unit_optimized_mcdc_bytes_9_0, 2, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0},
  {11, (char *)vcast_unit_stmt_bytes_11, sizeof(vcast_unit_stmt_bytes_11), (char *)vcast_unit_optimized_mcdc_bytes_11_0, 11, (char *)vcast_unit_optimized_mcdc_bytes_11_1, 3, (char *)vcast_unit_optimized_mcdc_bytes_11_2, 1, (char *)vcast_unit_optimized_mcdc_bytes_11_3, 2, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0, (char *)0, 0},
