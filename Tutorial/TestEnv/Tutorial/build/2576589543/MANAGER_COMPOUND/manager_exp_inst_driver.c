/*vcast_separate_expansion_start:S0000011.c*/
/***********************************************
...
---------------------------------------------
*/
#include "c:/vcast/vcast.win64.2021sp3/mingw/include/stdlib.h"
#include "c:/vcast/vcast.win64.2021sp3/mingw/include/setjmp.h"
#include "c:/vcast/vcast.win64.2021sp3/mingw/include/stdio.h"
#include "c:/vcast/vcast.win64.2021sp3/mingw/include/string.h"
...
#include "c:/vcast/vcast.win64.2021sp3/mingw/include/limits.h"
#include "c:/vcast/vcast.win64.2021sp3/mingw/lib/gcc/mingw32/6.3.0/include/float.h"
/* FUNCTION PROTOTYPES */
...
void VCAST_TI_8_3 ( int *vcast_param ) ;
      ...
      if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
        ...
        if (VCAST_FIND_INDEX() == -1) {
          ...
          *VCAST_TI_11_1_memory_ptr = (void*)VCAST_malloc(VCAST_TI_11_1_array_size*(sizeof(struct order_type )));
          memset((void*)*vcast_param, 0x0, VCAST_TI_11_1_array_size*(sizeof(struct order_type )));
          ;
        }
      ...
      if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
        ...
        if (VCAST_FIND_INDEX() == -1) {
          ...
          *VCAST_TI_11_10_memory_ptr = (void*)VCAST_malloc(VCAST_TI_11_10_array_size*(sizeof(char )));
          memset((void*)*vcast_param, 0x0, VCAST_TI_11_10_array_size*(sizeof(char )));
          ;
        }
      } else if (vCAST_VALUE_NUL == vCAST_true && vcast_proc_handles_command(1)) {
        if (VCAST_FIND_INDEX() == -1)
