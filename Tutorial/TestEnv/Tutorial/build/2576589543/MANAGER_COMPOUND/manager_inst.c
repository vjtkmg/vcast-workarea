...
extern VCAST_AVLTree vcast_unit_mcdc_bytes_11[];
extern char vcast_unit_optimized_mcdc_bytes_11_0[];
extern char vcast_unit_optimized_mcdc_bytes_11_1[];
extern char vcast_unit_optimized_mcdc_bytes_11_2[];
extern char vcast_unit_optimized_mcdc_bytes_11_3[];
extern char vcast_unit_optimized_mcdc_bytes_11_4[];
extern char vcast_unit_optimized_mcdc_bytes_11_5[];
extern char vcast_unit_optimized_mcdc_bytes_11_6[];
extern char vcast_unit_optimized_mcdc_bytes_11_7[];
extern char vcast_unit_optimized_mcdc_bytes_11_8[];
#ifdef __cplusplus
} /* end extern */
#endif
...
/*vcast_internal_end*/
 /*vcast_internal_start*/{/*vcast_internal_end*/
  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 0, 1);
if( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME(vcast_unit_optimized_mcdc_bytes_11_3, &vcast_mcdc_statement, 11, 0, 3, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(Order->Entree == STEAK))
 &&
...
if( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME(vcast_unit_optimized_mcdc_bytes_11_3, &vcast_mcdc_statement, 11, 1, 3, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(Order->Entree == LOBSTER))
 &&
...
struct table_data_type Table_Data;
  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 1, 1);
...
Table_Data.Order[Seat] = MyOrder;
  ...
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,6);
Add_Included_Dessert(&Table_Data.Order[Seat]);
  {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,7);
{vcast_switch_taken_1 = 0;
switch(MyOrder.Entree)
    {
    case NO_ENTREE :VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 2, 1);vcast_switch_taken_1 = 1;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,8);
break;
    case STEAK :if (!vcast_switch_taken_1) VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 3, 1);vcast_switch_taken_1 = 1;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,9);
Table_Data.Check_Total = Table_Data.Check_Total + 14.0 + 10;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,10);
break;
    case CHICKEN :if (!vcast_switch_taken_1) VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 4, 1);vcast_switch_taken_1 = 1;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,11);
Table_Data.Check_Total = Table_Data.Check_Total + 10.0;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,12);
break;
    case LOBSTER :if (!vcast_switch_taken_1) VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 5, 1);vcast_switch_taken_1 = 1;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,13);
Table_Data.Check_Total = Table_Data.Check_Total + 18.0;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,14);
break;
    case PASTA :if (!vcast_switch_taken_1) VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 6, 1);vcast_switch_taken_1 = 1;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,15);
Table_Data.Check_Total = Table_Data.Check_Total + 12.0;
       VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,16);
break;
    }}
}
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,17);
Update_Table_Record(Table, Table_Data);
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,18);
return 0;
 /*vcast_internal_start*/}/*vcast_internal_end*/
}
...
struct table_data_type Table_Data;
  seat_index_type Seat;
  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 7, 1);
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,19);
Table_Data = Get_Table_Record(Table);
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,20);
Table_Data.Is_Occupied = v_false;
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,21);
Table_Data.Number_In_Party = 1;
  {
for (Seat=0;  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_1(vcast_unit_optimized_mcdc_bytes_11_1, &vcast_mcdc_statement, 11, 0, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(Seat < 4))
)); Seat++){
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,22);
Table_Data.Order[Seat].Soup = NO_SOUP;
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,23);
Table_Data.Order[Seat].Salad = NO_SALAD;
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,24);
Table_Data.Order[Seat].Entree = NO_ENTREE;
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,25);
Table_Data.Order[Seat].Dessert = NO_DESSERT;
      VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,26);
Table_Data.Order[Seat].Beverage = NO_BEVERAGE;
   }}
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,27);
Table_Data.Check_Total = 0;
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,28);
Update_Table_Record(Table, Table_Data);
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,29);
return 0;
 /*vcast_internal_start*/}/*vcast_internal_end*/
}
...
/*vcast_internal_end*/
 /*vcast_internal_start*/{/*vcast_internal_end*/
  struct table_data_type Table_Data;
  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 8, 1);
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,30);
Table_Data = Get_Table_Record(Table);
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,31);
...
/*vcast_internal_end*/
 /*vcast_internal_start*/{/*vcast_internal_end*/
    struct vcast_mcdc_statement vcast_mcdc_statement = {0, 0};
int i = (VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 9, 1),(VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,32),0));
  if( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_1(vcast_unit_optimized_mcdc_bytes_11_1, &vcast_mcdc_statement, 11, 1, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(WaitingListSize > 9))
)))
    {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,33);
WaitingListSize = 0;}
  {
while( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME(vcast_unit_optimized_mcdc_bytes_11_2, &vcast_mcdc_statement, 11, 0, 2, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(!!(Name)))
 && VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 2, (VCAST_CONDITION_TYP)(*Name))
))) {
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,34);
WaitingList[WaitingListSize][i++] = *Name;
    VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,35);
Name++;
  }}
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,36);
...
/*vcast_internal_end*/
 /*vcast_internal_start*/{/*vcast_internal_end*/
  VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_0(vcast_unit_optimized_mcdc_bytes_11_0, 11, 10, 1);
if( VCAST_OPTIMIZED_MCDC_CONDITION_INSTRUMENTATION_POINT_REALTIME_1(vcast_unit_optimized_mcdc_bytes_11_1, &vcast_mcdc_statement, 11, 2, (VCAST_CONDITION_TYP)(VCAST_SAVE_MCDC_SUBCONDITION(&vcast_mcdc_statement, 1, (VCAST_CONDITION_TYP)(WaitingListIndex > 9))
)))
    {
VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,37);
WaitingListIndex = 0;}
  VCAST_STATEMENT_INSTRUMENTATION_POINT_REALTIME(vcast_unit_stmt_bytes_11,11,38);
